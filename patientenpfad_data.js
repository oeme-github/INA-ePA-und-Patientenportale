...
// gesetze: Erster Entwurf – bitte durch Arbeitsgruppe prüfen und ergänzen
...
const data = [
  ...
  },
  {
    ...
    dr: ['portal', 'versorgung'],
    domäne: 'Befunde',
    gesetze: ['DSGVO Art. 9', 'BGB § 630g (Akteneinsicht)', 'KHZG', 'SGB V § 341 ff.'],
...

  {
    ...
    dr: ['portal', 'versorgung', 'epa', 'ehds'],
    domäne: 'Dokumente',
    gesetze: ['BGB § 630f + § 630g', 'DSGVO Art. 9', 'SGB V § 39', 'MBO-Ä § 10'],
