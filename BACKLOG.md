...
**Cutover-Checkliste, SSO-Entscheidung + Audit-Protokoll, PR #45/#46 offen (2026-07-19, Fortsetzung):** SSO-Entscheidung getroffen (Magic-Link reicht zum Start, PR #45). Audit-/Versionsprotokoll als harte Anforderung entschieden und umgesetzt — `process_step_audit` wird jetzt per Trigger aktiv befüllt statt nur angelegt (PR #46). Details siehe KONTEXT.md.
