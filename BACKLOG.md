...
**E08 abgeschlossen (2026-07-19):** Drag&Drop für Reihenfolge (Prozessschritte, Dimension-Werte, Dimensionen-Liste selbst) im Editor umgesetzt, inkl. Nachbesserungen aus Nutzer-Review (Boxen-Layout je Listeneintrag, Viewer-Toolbar-Zeilenabstand, zusätzliche Nav-Dimension jetzt als Karten-Badge sichtbar). Details siehe KONTEXT.md. **PR #37 offen** (https://github.com/oeme-github/INA-ePA-und-Patientenportale/pull/37) — Nutzer hat sich das Ergebnis lokal angesehen und für gut befunden, aber noch keinen Merge-Auftrag erteilt. **Nächster Schritt: PR #37 mergen** (nach Rücksprache), danach ist der Viewer-/Editor-Abgleich inkl. E08 vollständig abgeschlossen.
